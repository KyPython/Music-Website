...
$credentialsFile = __DIR__ . '/Zoho CRM/credentials.php';
if (file_exists($credentialsFile)) {
    require_once $credentialsFile;
    logDebug("Loaded credentials from file");
} else {
    logDebug("Credentials file not found at: " . $credentialsFile);
    http_response_code(500);
    echo json_encode(['error' => 'Configuration error - credentials file not found']);
    exit;
}
